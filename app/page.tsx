  ...
  function handleTouchEnd(e: React.TouchEvent) {
    ...
    if (returnEl && drag.type === "placed") {
      ...
      if (drag.type === "rack") {
        ...
        setDraggedTile(null)
        setDraggedPlacedTile({ row: drag.row, col: drag.col, letter: drag.letter })
    ...
    >
      <div style={{ maxWidth: "920px", margin: "0 auto" }}>
        ...
        {gameOver && (
          ...
          >
            <div style={{ fontSize: "12px", textTransform: "uppercase", letterSpacing: "0.12em", color: "#567347", fontWeight: 800 }}>
              Puzzle Complete
            </div>
